...
public class SortingStudentTests {
    ...
    public void testCocktailShakerSort() {
        ...
        assertTrue("Number of comparisons: " + comp.getCount(),
                comp.getCount() <= 45);
        System.out.println("cocktail: " + comp.getCount());
    }
    ...
    public void testInsertionSort() {
        ...
        assertTrue("Number of comparisons: " + comp.getCount(),
                comp.getCount() <= 30);
        System.out.println("insertion: " + comp.getCount());
    }
    ...
    public void testSelectionSort() {
        ...
        for (int i = 1; i < tas.length; i++) {
            assertTrue(tas[i].getName().compareTo(tas[i - 1].getName()) >= 0);
        }
        assertTrue("Number of comparisons: " + comp.getCount(),
                comp.getCount() <= 45);
        System.out.println("selection: " + comp.getCount());
    }
    ...
    public void testQuickSort() {
        ...
        assertTrue("Number of comparisons: " + comp.getCount(),
                comp.getCount() <= 45);
        System.out.println("quick: " + comp.getCount());
    }
    ...
    public void testMergeSort() {
        ...
        assertTrue("Number of comparisons: " + comp.getCount(),
                comp.getCount() <= 48);
        System.out.println("merge: " + comp.getCount());
    }
